...
class AprioriCalculation
{
    ...
    String configFile="pattern_mining/files/config.txt";
    String transaFile="pattern_mining/files/chess.dat";//"transa.txt";
    String outputFile="pattern_mining/files/apriori-output.txt";
    int numItems;
    int numTransactions;
    double minSup;
    String oneVal[];
